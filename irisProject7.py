...
print("Variance within sesota     - GRP 1 is: ", calcWithinGroupsVariance(x.H1, y))   
print("Variance within versiculum - GRP 2 is: ", calcWithinGroupsVariance(x.H2, y))
print("Variance within seticulum  - GRP 3 is: ", calcWithinGroupsVariance(x.H3, y))
print("")
...
print("Variance between sesota     - GRP 1 is: ", calcBetweenGroupsVariance(x.H1, y))   
print("Variance between versiculum - GRP 2 is: ", calcBetweenGroupsVariance(x.H2, y))
print("Variance between seticulum  - GRP 3 is: ", calcBetweenGroupsVariance(x.H3, y))
print("")
